...
目前 v2ray-core 项目由 [oceantide 社区](https://github.com/oceantide) 继续提供代码维护，由于精力有限且项目复杂度较高，只维护主线代码的功能和安全性完整。原则上主页的兼容性保证继续遵循，
如有例外另行说明。

Currently v2ray-core project is maintained by [oceantide community](https://github.com/oceantide). Feature and security guarantee may only be limited to the
...
使用邮箱: security |at| oceantide.org。

Report to email: security |at| oceantide.org.
...
uid           [ 绝对 ] oceantide Developers <dev@oceantide.org>
